...
position VARCHAR(50) NOT NULL CHECK (position IN ('recepcjonistka', 'pokojowka', 'portier','dyrektor','sprzataczka'))
);
...
method_of_payment VARCHAR(50) DEFAULT('gotowka') CHECK (method_of_payment IN ('gotowka', 'karta', 'bon','blik','czek'))
);
...
DROP VIEW penalties_reservation CASCADE;płatność usługi
